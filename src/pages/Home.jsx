...
export default function Home() {
  ...
  const loadCategories = async () => {
    const data = await base44.entities.Category.list('-created_date', 8);
    setCategories(data);
    setLoading(false);
  };
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                onClick={() => base44.auth.redirectToLogin(createPageUrl('CompleteProfile'))}
                variant="outline"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#FF6B3D] to-[#FF5722] px-4 py-2 rounded-full mb-4">
              <span className="text-sm font-semibold" style={{ color: 'black' }}>★ FEATURED</span>
            </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-10">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Browse Categories</h2>
              <p className="text-gray-500">Explore services from verified professionals</p>
            </div>
            <Link
      ...
      {/* How It Works */}
      <section className="py-16 lg:py-24 bg-[#1A1D2E]/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">How It Works</h2>
            <p className="text-gray-500 max-w-2xl mx-auto">Get started in three simple steps</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { step: '01', title: 'Find a Provider', description: 'Browse categories and discover skilled professionals near you' },
              { step: '02', title: 'Hire & Fund', description: 'Create a job and securely fund it through our escrow system' },
              { step: '03', title: 'Get It Done', description: 'Receive quality service and release payment upon completion' }
            ].map((item, index) => (
              <div key={index} className="relative">
                <div className="text-7xl font-bold text-[#FF6633]/10 absolute -top-4 -left-2">
                  {item.step}
                </div>
          ...
          <div className="card-dark p-8 lg:p-12 text-center bg-gradient-to-br from-[#FF6633]/10 to-transparent">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to={createPageUrl('Categories')}>
                <Button variant="outline" className="border-[#2A2D3E] text-white hover:bg-[#1A1D2E] w-full sm:w-auto">
                  Browse Services
                </Button>
              </Link>
            </div>
