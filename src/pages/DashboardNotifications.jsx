    ...
    return (
      <div className="p-6 lg:p-8">
        <div className="animate-pulse space-y-4">
          ...
          {[...Array(5)].map((_, i) => (
            <div key={i} className="h-20 bg-[#2A2D3E] rounded-xl" />
          ))}
        </div>
      </div>
    );
        ...
        <div className="space-y-3">
          {notifications.map((notification) => {
            ...
            return (
              <div
                key={notification.id}
                className={`card-dark p-4 flex items-start gap-4 ${
                  !notification.is_read ? "border-l-2 border-l-[#FF6633]" : ""
                }`}
              >
                <div
                      ...
                      {notification.link && (
                        ...
                        >
                          <Button
                            size="sm"
                            variant="ghost"
                            className="text-[#FF6633] hover:text-[#E55A2B]"
                          >
                            View
                          </Button>
                        </Link>
